...
in
{
  ...
  config.flake = rec {
    homeModules = readModules { dir=cfg.home.modulesDirectory; };
    nixosModules = readModules { dir=cfg.nixos.modulesDirectory; };
    darwinModules = readModules { dir=cfg.darwin.modulesDirectory; };
